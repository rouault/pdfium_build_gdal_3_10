...
FOR %%X IN (build constants fpdfsdk core\fxge core\fxge\agg core\fxge\dib core\fpdfdoc core\fpdfapi\parser core\fpdfapi\page core\fpdfapi\render core\fxcrt third_party\agg23 core\fxcrt\numerics) DO (
